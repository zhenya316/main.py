...
К сожалению, у вас не так много времени, чтобы подбирать пароль вручную, шипы сверху уже движутся на вас (обожаю клише), тем более числа в первой вставке
будут попадаться случайно.
...
def password_selection(n):
    ...
    return result
a = password_selection(int(input('Введите число для подбора пароля: ')))
print(int(a))
